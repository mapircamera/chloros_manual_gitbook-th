...
เมื่อคุณเปิดตัว Chloros และ Chloros (เบราว์เซอร์) เป็นครั้งแรก มันจะเริ่มต้นแบ็กเอนด์ เมื่อพร้อมแล้ว ไอคอนเมนูหลักด้านซ้ายบนจะปรากฏขึ้น <img src=".gitbook/assets/image (1).png" alt="" data-size="line">
