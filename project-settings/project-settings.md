...
* **ช่วง**: 0 ถึง 100
* **ค่าเริ่มต้น**: 60
* **คำอธิบาย**: ควบคุมเกณฑ์การจัดกลุ่มสำหรับการจัดกลุ่มขอบเขตสีที่คล้ายกันเมื่อตรวจพบเป้าหมายการปรับเทียบ ค่าที่สูงกว่าจำเป็นต้องมีสีที่คล้ายกันมากขึ้นในการจัดกลุ่มเข้าด้วยกัน ส่งผลให้การตรวจจับเป้าหมายระมัดระวังมากขึ้น ค่าที่ต่ำกว่าจะทำให้สีมีความหลากหลายมากขึ้นภายในกลุ่มเป้าหมาย
* **เมื่อใดควรปรับเปลี่ยน**:
...
1. **เริ่มต้นด้วยค่าเริ่มต้น**: การตั้งค่าเริ่มต้นทำงานได้ดีกับระบบกล้อง MAPIR ส่วนใหญ่และขั้นตอนการทำงานทั่วไป
...
สำหรับข้อมูลเพิ่มเติมเกี่ยวกับดัชนีหลายสเปกตรัมใน Chloros โปรดดูหน้า [สูตรดัชนีหลายสเปกตรัม](multispectral-index-formulas.md)