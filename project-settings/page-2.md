...
* **เมื่อใดควรปรับเปลี่ยน**:
  * เพิ่มขึ้นหากคุณได้รับการตรวจจับที่ผิดพลาดในส่วนที่เป็นรูปภาพขนาดเล็ก
...
* **คำอธิบาย**: ใช้การแก้ไขขอบมืดเพื่อชดเชยการทำให้เลนส์มืดลงที่ขอบภาพ ขอบมืดเป็นปรากฏการณ์ทางการมองเห็นทั่วไปที่มุมและขอบของภาพดูเข้มกว่ากึ่งกลางเนื่องจากลักษณะของเลนส์
* **เมื่อใดที่ควรปิดใช้งาน**: ปิดใช้งานเฉพาะในกรณีที่กล้อง/เลนส์ของคุณใช้การแก้ไขขอบมืดอยู่แล้ว หรือหากคุณต้องการแก้ไขขอบมืดด้วยตนเองในขั้นตอนหลังการประมวลผล

### การสอบเทียบการสะท้อนแสง / สมดุลสีขาว
...
* **เมื่อใดควรปรับเปลี่ยน**:
  ...
  * เพิ่ม (เช่น เป็น 60-300 วินาที) เพื่อการประมวลผลที่เร็วขึ้นเมื่อมีแสงสม่ำเสมอ และคุณมีภาพเป้าหมายการปรับเทียบบ่อยครั้ง
...
* **เมื่อใดที่ควรเปิดใช้งาน**: ขอแนะนำให้เปิดใช้งานการแก้ไข PPK เสมอ หากคุณมีรายการตอบรับความเสี่ยงในไฟล์บันทึก .daq ของคุณ
...
* **ตัวเลือก**:
  * ตรวจพบชื่อรุ่นกล้องในโปรเจ็กต์
  * "ห้ามใช้" - ละเว้นพินการเปิดรับแสงนี้
...
* **ประเภท**: การเลือกแบบเลื่อนลง
* **การมองเห็น**: มองเห็นได้เฉพาะเมื่อเปิดใช้งาน "ใช้การแก้ไข PPK" และข้อมูลการสัมผัสพร้อมใช้งานสำหรับพิน 2
* **ตัวเลือก**:
  * ตรวจพบชื่อรุ่นกล้องในโปรเจ็กต์
  * "ห้ามใช้" - ละเว้นพินการเปิดรับแสงนี้
* **ค่าเริ่มต้น**: เลือกอัตโนมัติตามการกำหนดค่าโปรเจ็กต์
...
* **ดัชนีที่มี**: ระบบประกอบด้วยดัชนีหลายสเปกตรัมที่กำหนดไว้ล่วงหน้ามากกว่า 30 รายการ ซึ่งรวมถึง:
  * NDVI (ดัชนีพืชพรรณความแตกต่างปกติ)
  * NDRE (ความแตกต่างปกติ RedEdge)
  * EVI (ดัชนีพืชพรรณที่ปรับปรุงแล้ว)
  * GNDVI, SAVI, OSAVI, MSAVI2
  * และอื่นๆ อีกมากมาย (ดู [สูตรดัชนีหลายสเปกตรัม](multispectral-index-formulas.md) สำหรับรายการทั้งหมด)
* **คุณสมบัติ**:
  * เลือกจากสูตรดัชนีที่กำหนดไว้ล่วงหน้า
  * กำหนดค่าการไล่ระดับสีของการแสดงภาพ (LUT - ตารางตรวจสอบ)
...
* **ไวยากรณ์ของสูตร**: รองรับการดำเนินการทางคณิตศาสตร์มาตรฐาน ได้แก่:
  ...
  * การอ้างอิงสาย: NIR, แดง, เขียว, น้ำเงิน, RedEdge, ฟ้า, ส้ม, NIR1, NIR2
...
* **ตัวเลือก**:
  ...
  * **TIFF (32 บิต เปอร์เซ็นต์)** - TIFF จุดลอยตัว 32 บิตพร้อมค่าการสะท้อนเป็นเปอร์เซ็นต์
  * **PNG (8 บิต)** - รูปแบบ PNG ที่ถูกบีบอัด 8 บิต
  * **JPG (8 บิต)** - รูปแบบ JPEG 8 บิตที่บีบอัด
...
* **คำแนะนำรูปแบบ**:
  ...
  * **JPG (8 บิต)**: ขนาดไฟล์เล็กที่สุด เหมาะสำหรับการแสดงตัวอย่างและแสดงเว็บเท่านั้น ใช้การบีบอัดแบบสูญเสียซึ่งไม่เหมาะสำหรับการวิเคราะห์ทางวิทยาศาสตร์
...
* **กรณีการใช้งาน**:
  ...
  * บันทึกการกำหนดค่ามาตรฐานสำหรับประเภทการครอบตัดเฉพาะหรือเวิร์กโฟลว์การวิเคราะห์
...
การตั้งค่าโครงการทั้งหมดจะถูกบันทึกโดยอัตโนมัติพร้อมกับไฟล์โครงการของคุณ (`.mapir` รูปแบบโครงการ) เมื่อคุณเปิดโปรเจ็กต์อีกครั้ง การตั้งค่าทั้งหมดจะถูกกู้คืนเหมือนกับที่คุณทิ้งไว้
...
3. **ทดสอบก่อนประมวลผลเต็มรูปแบบ**: เมื่อทดลองการตั้งค่าใหม่ ให้ทดสอบภาพชุดย่อยเล็กๆ ก่อนประมวลผลชุดข้อมูลทั้งหมด
...
5. **การเลือกรูปแบบการส่งออก**: เลือกรูปแบบการส่งออกของคุณตามการใช้งานปลายทางของคุณ:
   ...
   * การแสดงภาพอย่างรวดเร็ว → PNG (8 บิต)
   * การแชร์เว็บ → JPG (8 บิต)

-

สำหรับข้อมูลเพิ่มเติมเกี่ยวกับดัชนีหลายสเปกตรัมในคลอรอส ดูหน้า [สูตรดัชนีหลายสเปกตรัม](multispectral-index-formulas.md)
