...
{% hint style="info" %}**ประเภทไฟล์ที่รองรับ**: Chloros รองรับไฟล์ภาพ RAW+JPG และ JPG จากกล้อง MAPIR Survey3W และ Survey3N แนะนำให้ใช้เฉพาะ RAW+JPG เท่านั้น
{% endhint %}***## การเพิ่มรูปภาพในโครงการของคุณ
...
4. การประมวลผลใช้การตั้งค่าที่ถูกต้องสำหรับกล้องแต่ละประเภท**สถานการณ์ตัวอย่าง**: การตั้งค่ากล้องคู่ Survey3W RGN + Survey3N OCN***
...
## รูปภาพไม่ปรากฏหลังจากการนำเข้า**สาเหตุที่เป็นไปได้:**
...
## ตรวจไม่พบรุ่นกล้อง**สาเหตุที่เป็นไปได้:**

* แก้ไขข้อมูลเมตา EXIF
* รูปภาพที่แก้ไขด้วยซอฟต์แวร์ภายนอก
* การถ่ายโอนไฟล์ไม่สมบูรณ์ **วิธีแก้ปัญหา**: นำเข้าไฟล์ต้นฉบับที่ยังไม่ได้แก้ไขอีกครั้งจากกล้อง/การ์ด SD


## การประทับเวลาหายไป**สาเหตุที่เป็นไปได้:**

* นาฬิกาในกล้องไม่ได้ตั้งค่าอย่างถูกต้อง
* ข้อมูล EXIF ​​​​ถูกปล้นโดยซอฟต์แวร์ภายนอก

**วิธีแก้ปัญหา**: ตรวจสอบว่าการตั้งค่าเวลาของกล้องถูกต้องระหว่างการถ่ายภาพ***## ขั้นตอนต่อไป
