...
ใช้ตัวเลือกนี้เพื่อนำเข้าไฟล์รูปภาพแต่ละไฟล์หรือไฟล์ที่เลือกจำนวนเล็กน้อย

1. คลิกปุ่ม **"Add Files"** <img src="../.gitbook/assets/image.png" alt="" data-size="line"> ที่ด้านบนของแผง File Browser
...
เมื่อนำเข้ารูปภาพแล้ว รูปภาพเหล่านั้นจะปรากฏในตารางโดยมีคอลัมน์ต่อไปนี้:
...
การคลิกปุ่มสลับที่มุมขวาบนเหนือตารางจะแสดงข้อมูลเมตาของรูปภาพที่เลือกในพื้นที่ตารางรูปภาพ
...
2. คลิกปุ่ม **"ลบรายการที่เลือก"** <img src="../.gitbook/assets/image (2).png" alt="" data-size="line">
...
{% hint style="warning" %}
**ข้อสำคัญ**: ห้ามเปลี่ยนชื่อหรือแก้ไขไฟล์ภาพต้นฉบับของคุณก่อนที่จะนำเข้า Chloros อาศัยชื่อไฟล์ต้นฉบับและข้อมูลเมตาเพื่อการประมวลผลที่เหมาะสม
{% endhint %}
...
3. File Browser แสดงรุ่นกล้องในคอลัมน์ Camera Model
4. การประมวลผลใช้การตั้งค่าที่ถูกต้องสำหรับกล้องแต่ละประเภท

**สถานการณ์ตัวอย่าง**: Survey3W RGN + Survey3N OCN การตั้งค่ากล้องคู่
...
* ภาพมาจากกล้องที่ไม่ใช่ MAPIR (ดู [กล้องที่รองรับ](../supported-cameras.md))
* ไฟล์เสียหายหรือถ่ายโอนไม่สมบูรณ์จากการ์ด SD
...
**วิธีแก้ปัญหา**: นำเข้าไฟล์ต้นฉบับที่ยังไม่ได้แก้ไขจากกล้อง/การ์ด SD อีกครั้ง
...
สำหรับข้อมูลโดยละเอียดเกี่ยวกับการกำหนดค่าโปรเจ็กต์ โปรดดู [การปรับการตั้งค่าโปรเจ็กต์](adjusting-project-settings.md)