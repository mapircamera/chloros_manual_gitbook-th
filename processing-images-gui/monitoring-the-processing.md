...
เมื่อการประมวลผลเริ่มต้นแล้ว Chloros มีหลายวิธีในการติดตามความคืบหน้า ตรวจสอบปัญหา และทำความเข้าใจว่าเกิดอะไรขึ้นกับชุดข้อมูลของคุณ หน้านี้อธิบายวิธีติดตามการประมวลผลของคุณและตีความข้อมูลที่ Chloros มอบให้
...
4. **การส่งออก** - บันทึกไฟล์ที่ประมวลผลแล้ว**คุณสมบัติแบบโต้ตอบ:*** **วางเมาส์เหนือ** แถบความคืบหน้าเพื่อดูแผง 4 ขั้นที่ขยาย
...
* Chloros สแกนภาพที่ทำเครื่องหมายด้วยช่องทำเครื่องหมาย Target
...
**ระยะเวลา:** เวลาประมวลผลส่วนใหญ่ (60-80%)**ตัวบ่งชี้ความคืบหน้า:**

* การปรับเทียบ: 0% → 100%
* ภาพปัจจุบันกำลังถูกประมวลผล
* รูปภาพที่เสร็จสมบูรณ์ / รูปภาพทั้งหมด

**พฤติกรรมการประมวลผล:*** **โหมดฟรี**: ประมวลผลภาพทีละภาพตามลำดับ
* **โหมด Chloros+**: ประมวลผลภาพได้สูงสุด 16 ภาพพร้อมกัน
...
4. ส่งไปที่ฝ่ายสนับสนุน MAPIR หากจำเป็น
...
* Windows ตัวจัดการงาน (Ctrl+Shift+Esc)
* แท็บประสิทธิภาพ → ส่วน CPU
* ค้นหากระบวนการ "Chloros" หรือ "chloros-backend"
...
* Chloros+ โหมดขนานใช้ RAM มากกว่า
...
* ตรวจสอบ Task Manager เพื่อให้แน่ใจว่า Chloros กำลังทำงานอยู่
...
* Chloros+ โหมดขนานใช้ทรัพยากรมากเกินไป
...
3. ลดภาระการประมวลผล (ใช้โหมดฟรีแทน Chloros+)
...
1. **ผลการตรวจสอบ** - ดู [การประมวลผลให้เสร็จสิ้น](finishing-the-processing.md)
