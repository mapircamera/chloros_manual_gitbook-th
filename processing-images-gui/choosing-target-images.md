...
* ตรวจสอบภาพนับร้อยหรือหลายพันภาพโดยไม่จำเป็น **ผลลัพธ์**: การประมวลผลอาจใช้เวลานานกว่ามาก โดยเฉพาะชุดข้อมูลขนาดใหญ่
...
{% endhint %}***## วิธีทำเครื่องหมายรูปภาพเป้าหมาย


## ขั้นตอนที่ 1: ระบุรูปภาพเป้าหมายของคุณ

ดูภาพที่นำเข้าของคุณใน File Browser และระบุว่าภาพใดมีเป้าหมายการปรับเทียบ**สถานการณ์ทั่วไป:*** **เป้าหมายการจับภาพล่วงหน้า**: จับภาพก่อนเริ่มเซสชัน
...
* ให้กล้องขนาน/ขีดตกต่ำสุดกับพื้นผิวเป้าหมาย **แสงสว่าง:**
...
* สภาพที่มืดครึ้มให้ผลลัพธ์ที่สม่ำเสมอที่สุด **เงื่อนไขเป้าหมาย:**
...
**ขั้นต่ำ:**1 รูปภาพเป้าหมายต่อเซสชัน**แนะนำ:**รูปภาพเป้าหมาย 3-5 ภาพต่อเซสชัน**ตารางแนวทางปฏิบัติที่ดีที่สุด:**
...
หากคลอรอสตรวจจับเป้าหมายของคุณไม่ถูกต้อง ให้ปรับการตั้งค่าเหล่านี้ใน [การตั้งค่าโครงการ](adjusting-project-settings.md):**พื้นที่ตัวอย่างการสอบเทียบขั้นต่ำ:*** **ค่าเริ่มต้น**: 25 พิกเซล
* **เพิ่มขึ้น** หากตรวจพบสิ่งประดิษฐ์ขนาดเล็กที่ผิดพลาด
* **ลดลง**หากตรวจไม่พบเป้าหมาย**การจัดกลุ่มเป้าหมายขั้นต่ำ:*** **ค่าเริ่มต้น**: 60
* **เพิ่มขึ้น** หากเป้าหมายถูกแบ่งออกเป็นหลายการตรวจจับ
* **ลดลง**หากตรวจไม่พบเป้าหมายที่มีความแปรผันของสีทั้งหมด***## ปัญหารูปภาพเป้าหมายทั่วไป


## ปัญหา: ไม่พบเป้าหมาย**สาเหตุที่เป็นไปได้:**

* กำหนดเป้าหมายรูปภาพที่ไม่ได้ทำเครื่องหมายใน File Browser
* เป้าหมายเล็กเกินไปในเฟรม (< 30% ของภาพ)
* สภาพแสงไม่ดี (เงา แสงจ้า)
* การตั้งค่าการตรวจจับเป้าหมายเข้มงวดเกินไป **แนวทางแก้ไข:**1. ตรวจสอบคอลัมน์เป้าหมายว่ามีการตรวจสอบรูปภาพที่ถูกต้อง
2. ตรวจสอบคุณภาพของภาพเป้าหมายในหน้าตัวอย่าง
3. ยึดเป้าหมายคืนหากคุณภาพไม่ดี
4. ปรับการตั้งค่าการตรวจจับเป้าหมายหากจำเป็น


## ปัญหา: การตรวจจับเป้าหมายเท็จ**สาเหตุที่เป็นไปได้:**

* อาคารสีขาว ยานพาหนะ หรือสิ่งปกคลุมดินที่เข้าใจผิดว่าเป็นเป้าหมาย
* รอยสดใสในพืชพรรณ
* ความไวในการตรวจจับต่ำเกินไป **แนวทางแก้ไข:**1. ทำเครื่องหมายเฉพาะภาพเป้าหมายจริงเพื่อจำกัดขอบเขตการตรวจจับ
...
{% hint style="warning" %}**ไม่แนะนำ**: หากไม่มีการปรับเทียบการสะท้อนแสง ค่าพิกเซลจะแสดงถึงความสว่างสัมพัทธ์เท่านั้น ไม่ใช่การวัดการสะท้อนแสงทางวิทยาศาสตร์ ใช้เป้าหมายการสอบเทียบเพื่อให้ได้ผลลัพธ์ที่แม่นยำและทำซ้ำได้
{% endhint %}***## ขั้นตอนต่อไป
