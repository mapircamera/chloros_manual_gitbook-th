...
{% hint style="info" %}**เคล็ดลับ**: คลิกดูภาพบางภาพใน File Browser เพื่อตรวจสอบว่าโหลดถูกต้องก่อนประมวลผล
{% endhint %}***
...
{% hint style="success" %}**เริ่มต้นการประมวลผล**: เมื่อคลิกแล้ว คลอรอสจะจัดการขั้นตอนการประมวลผลทั้งหมดโดยอัตโนมัติ - การตรวจจับเป้าหมาย การแยกส่วน การสอบเทียบ การคำนวณดัชนี และการส่งออก
{% endhint %}***## ทำความเข้าใจกับโหมดการประมวลผล

คลอรอสทำงานในโหมดการประมวลผลที่แตกต่างกันสองโหมด ขึ้นอยู่กับใบอนุญาตของคุณ:


## โหมดฟรี (การประมวลผลตามลำดับ)**ใช้ได้กับผู้ใช้ทุกคน**
**วิธีการทำงาน:**

* ประมวลผลภาพทีละภาพตามลำดับ
* การทำงานแบบเธรดเดียว
* การใช้หน่วยความจำลดลง **แถบความคืบหน้าแสดง 2 ขั้นตอน:**1.**การตรวจจับเป้าหมาย**- กำลังสแกนหาเป้าหมายการสอบเทียบ
...
**ต้องมีใบอนุญาตคลอรอส+** **วิธีการทำงาน:**
...
**แถบความคืบหน้าแสดง 4 ขั้นตอน:**1.**การตรวจจับ**- การค้นหาเป้าหมายการสอบเทียบ
...
{% endhint %}***## เกิดอะไรขึ้นระหว่างการประมวลผล


## ด่าน 1: การตรวจจับเป้าหมาย**คลอรอสทำอะไร:**
...
* บันทึกการประทับเวลาเป้าหมายสำหรับการกำหนดเวลาการสอบเทียบ **ระยะเวลา:**1-30 วินาที (โดยมีเป้าหมายที่ทำเครื่องหมายไว้), 5-30+ นาที (ไม่มีเครื่องหมาย)


## ด่าน 2: การดีบาย (การแปลงไฟล์ RAW)**คลอรอสทำอะไร:**

* แปลงข้อมูลรูปแบบ RAW Bayer เป็นภาพ RGB เต็มรูปแบบ
* ใช้อัลกอริทึม demosaicing คุณภาพสูง
* รักษาคุณภาพและรายละเอียดของภาพสูงสุด **ระยะเวลา:**แตกต่างกันไปตามจำนวนภาพและความเร็ว CPU


## ขั้นตอนที่ 3: การสอบเทียบ**คลอรอสทำอะไร:*** **การแก้ไขขอบมืด**: ลบการทำให้เลนส์มืดลงที่ขอบ
* **การปรับเทียบการสะท้อนแสง**: ทำให้เป็นมาตรฐานโดยใช้ค่าการสะท้อนแสงเป้าหมาย
* ใช้การแก้ไขในทุกแบนด์/ช่อง
* ใช้เป้าหมายการปรับเทียบที่เหมาะสมสำหรับแต่ละภาพโดยอิงจากการประทับเวลา **ระยะเวลา:**ส่วนใหญ่ของเวลาในการประมวลผล


## ขั้นตอนที่ 4: การคำนวณดัชนี**คลอรอสทำอะไร:**

* คำนวณดัชนีหลายสเปกตรัมที่กำหนดค่า (NDVI, NDRE ฯลฯ )
* ใช้แถบคณิตศาสตร์กับภาพที่ปรับเทียบแล้ว
* สร้างภาพดัชนีสำหรับแต่ละดัชนีที่เลือก **ระยะเวลา:**ไม่กี่วินาทีต่อภาพ


## ขั้นตอนที่ 5: ส่งออก**คลอรอสทำอะไร:**

* บันทึกภาพที่ปรับเทียบแล้วในรูปแบบที่เลือก
* ส่งออกภาพดัชนีด้วยสี LUT ที่กำหนดค่าไว้
* เขียนไฟล์ไปยังโฟลเดอร์ย่อยของรุ่นกล้อง
* รักษาชื่อไฟล์ต้นฉบับพร้อมส่วนต่อท้าย **ระยะเวลา:**แตกต่างกันไปตามรูปแบบการส่งออกและขนาดไฟล์***
...
## ไม่สามารถหยุดการประมวลผลชั่วคราวได้**ข้อจำกัดที่สำคัญ:**
...
* ต้องรีสตาร์ทตั้งแต่ต้นหากยกเลิก **เคล็ดลับการวางแผน:**สำหรับโปรเจ็กต์ขนาดใหญ่มาก ให้พิจารณาการประมวลผลเป็นชุดหรือใช้ CLI เพื่อการควบคุมที่ดีขึ้น***
...
สำหรับข้อมูลโดยละเอียดเกี่ยวกับการตรวจสอบ โปรดดู [การตรวจสอบการประมวลผล](monitoring-the-processing.md)***## กำลังยกเลิกการประมวลผล
...
## เมื่อจะยกเลิก**เหตุผลที่ถูกต้องในการยกเลิก:**

* มีการใช้การตั้งค่าที่ไม่ถูกต้อง
* ลืมทำเครื่องหมายภาพเป้าหมาย
* นำเข้ารูปภาพผิด
* ระบบทำงานช้าเกินไปหรือไม่ตอบสนอง **หลังจากยกเลิก:**
...
* โหมดการประมวลผล (ฟรี เทียบกับ คลอรอส+)
...
| จำนวนรูปภาพ | โหมดฟรี | คลอรอส+ (ซีพียู) | คลอรอส+ (GPU) - |
| ----------- | --------- | -------------- | -------------- |
...
{% endhint %}***## ปัญหาทั่วไปเมื่อเริ่มต้น


## ปุ่มเริ่มถูกปิดใช้งาน (เป็นสีเทา)**สาเหตุที่เป็นไปได้:**

* ไม่มีการนำเข้ารูปภาพ
* แบ็กเอนด์ไม่ได้เริ่มต้นอย่างสมบูรณ์
* การประมวลผลก่อนหน้านี้ยังคงทำงานอยู่
* โครงการยังโหลดไม่เต็มที่ **แนวทางแก้ไข:**1. รอให้แบ็กเอนด์เริ่มต้นอย่างสมบูรณ์ (ตรวจสอบไอคอนเมนูหลัก)
...
## การประมวลผลเริ่มต้นแล้วล้มเหลวทันที**สาเหตุที่เป็นไปได้:**
...
**แนวทางแก้ไข:**1. ตรวจสอบบันทึกการแก้ไขข้อบกพร่อง <img src="../.gitbook/assets/icon_log.JPG" alt="" data-size="line"> เพื่อดูข้อความแสดงข้อผิดพลาด
2. ตรวจสอบพื้นที่ว่างในดิสก์
3. ลองประมวลผลชุดย่อยของรูปภาพให้เล็กลง
4. ตรวจสอบว่ารูปภาพไม่เสียหาย


## คำเตือน "ไม่พบเป้าหมาย"**สาเหตุที่เป็นไปได้:**

* ลืมทำเครื่องหมายภาพเป้าหมาย
* รูปภาพเป้าหมายไม่มีเป้าหมายที่มองเห็นได้
* การตั้งค่าการตรวจจับเป้าหมายเข้มงวดเกินไป **แนวทางแก้ไข:**1. ตรวจสอบ [การเลือกรูปภาพเป้าหมาย](choosing-target-images.md)
...
4.**อย่าโหลดการใช้งานหนักๆ อื่นๆ**- โดยเฉพาะเมื่อใช้โหมดขนานคลอรอส+
...
4. ตรวจสอบอุณหภูมิ GPU (ให้แน่ใจว่ามีการระบายความร้อนเพียงพอ)***## ขั้นตอนต่อไป
...
3.**ผลการตรวจสอบ** - ดู [การตกแต่งขั้นสุดท้าย](finishing-the-processing.md)
