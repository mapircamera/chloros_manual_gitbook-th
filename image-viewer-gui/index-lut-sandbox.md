...
เข้าถึง Sandbox Index/LUT ได้ใน **Image Viewer** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> แท็บแถบด้านข้าง:

1. คลิกรูปภาพในตารางรูปภาพของเบราว์เซอร์ไฟล์ จากนั้นจะเปิดขึ้นในแท็บ **Image Viewer** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line">
2. คลิก **โปรแกรมดูรูปภาพ** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> เพื่อเปิดแถบด้านข้างที่แสดงออกมาทางซ้ายหากยังไม่ได้เปิดอยู่

### การเลือกรูปภาพเพื่อใช้ดัชนี/LUT

หากต้องการทำงานกับดัชนีในแซนด์บ็อกซ์ <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> ของ Image Viewer:

1. **เปิดรูปภาพ** จากตารางรูปภาพหลักโดยคลิกที่รูปภาพนั้น
2. แท็บ **โปรแกรมดูรูปภาพ** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> จะเปิดขึ้นมา
...
เมื่อรูปภาพแสดงแบบเต็มหน้าจอและ **Image Viewer** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> แถบด้านข้างของแท็บเปิดอยู่:
...
1. คลิกปุ่ม <img src="../.gitbook/assets/image (1) (1).png" alt="" data-size="line"> "+เพิ่ม LUT"
2. เลือกการไล่ระดับสี
3. ปรับจุดสิ้นสุดต่ำสุด/สูงสุดที่ตัด
4. ปรับโหมดการตัดภาพ
5. ทำเครื่องหมายที่ช่องดัชนีในแถบด้านข้างแท็บ **Image Viewer** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> เพื่อใช้ LUT
...
{% hint style="success" %}
**แนวทางปฏิบัติที่ดีที่สุด**: สำหรับดัชนีพืชพรรณ เช่น NDVI การไล่ระดับสี Red-Yellow-Green นั้นใช้งานง่ายที่สุด เนื่องจากสอดคล้องกับการเชื่อมโยงสีตามธรรมชาติ (สีเขียว=ดีต่อสุขภาพ สีเหลือง=ปานกลาง สีแดง=เน้น)
{% endhint %}
...
* **20+ คลาส**: เกือบต่อเนื่องและราบรื่นสูงสุด**วิธีการปรับ:**
...
* **ชั้นเรียนเพิ่มเติม** (15-20): การเปลี่ยนภาพอย่างราบรื่น รูปแบบที่มีรายละเอียด รูปลักษณ์ของภาพถ่าย**เมื่อใดควรใช้:*** **ไม่กี่ชั้นเรียน (3-5)**: สไลด์การนำเสนอ แผนที่การจัดหมวดหมู่ รายงานอย่างง่าย
...
**การควบคุมช่วงค่า**จะเป็นตัวกำหนดว่าค่าดัชนีใดจะจับคู่กับสีใดในการไล่ระดับสีของคุณ:**การควบคุมช่วงในแผง LUT:*** **ค่าขั้นต่ำ**: ขอบเขตล่างของระดับสี
...
1. ในแผง LUT ค้นหาช่องป้อนข้อมูล**ค่าต่ำสุด**และ**ค่าสูงสุด**
...
6. การแสดงภาพ **อัปเดตทันที**{% hint style="info" %}**ปรับขนาดอัตโนมัติ**: เมื่อคุณใช้ LUT เป็นครั้งแรก Chloros จะตั้งค่าต่ำสุด/สูงสุดเป็นช่วงข้อมูลจริงในรูปภาพโดยอัตโนมัติ จากนั้นคุณสามารถจำกัดช่วงนี้ให้แคบลงเพื่อเน้นไปที่ช่วงมูลค่าเฉพาะที่สนใจได้
{% endhint %}
...
เพื่อการควบคุมการแสดงภาพของคุณอย่างสมบูรณ์ คุณสามารถสร้าง **การไล่ระดับสีที่กำหนดเอง** ได้โดยการแก้ไขจุดสีแต่ละสี**วิธีสร้างการไล่ระดับสีแบบกำหนดเอง:**

1. ในแผง LUT ให้ค้นหา**แถบแสดงตัวอย่างการไล่ระดับสี**

2. มองหา**ช่องสี่เหลี่ยมตัวอย่างสี** ใต้การไล่ระดับสี
...
7. การไล่ระดับสี**อัปเดตทันที** บนรูปภาพ**การเพิ่มหรือลบการหยุดสี:*** **เพิ่มจุดหยุด**: คลิกไอคอน + เพื่อเพิ่มตัวอย่างใหม่ในตอนท้าย
...
{% hint style="success" %}
**ผลตอบรับสด**: ผลตอบรับด้วยภาพทันทีช่วยให้คุณสามารถทดสอบการตั้งค่าต่างๆ ได้อย่างรวดเร็ว จนกว่าคุณจะพบภาพที่ดีที่สุดสำหรับความต้องการในการวิเคราะห์ของคุณ
{% endhint %}
...
3. **ใช้การไล่ระดับสี LUT** - เริ่มต้นด้วยการตั้งค่าล่วงหน้า Red-Yellow-Green
...
1. ค่าพิกเซลจะแสดงเมื่อรูปภาพมีดัชนี หรือทั้งกล่องดัชนีและ LUT**ทำเครื่องหมาย**
...
3. ค้นหาตัวเลือก**"กำหนดเอง"** (ต้องเข้าสู่ระบบด้วยใบอนุญาต Chloros+)
...
* [**การประมวลผลภาพ (GUI)**](../processing-images-gui/adding-files-to-a-project.md) - ขั้นตอนการประมวลผลเต็มรูปแบบ