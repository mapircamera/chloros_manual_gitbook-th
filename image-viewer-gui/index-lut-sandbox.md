...
1. คลิกปุ่ม <img src="../.gitbook/assets/image (1) (1).png" alt="" data-size="line"> "+Add LUT"
...
6. การแสดงภาพ **อัปเดตทันที**{% คำใบ้สไตล์ = "ข้อมูล" %}**ปรับขนาดอัตโนมัติ**: เมื่อคุณใช้ LUT เป็นครั้งแรก Chloros จะตั้งค่าต่ำสุด/สูงสุดเป็นช่วงข้อมูลจริงในรูปภาพโดยอัตโนมัติ จากนั้นคุณสามารถจำกัดช่วงนี้ให้แคบลงเพื่อเน้นไปที่ช่วงมูลค่าเฉพาะที่สนใจได้
{% คำแนะนำสิ้นสุด %}
...
* **นำจุดหยุดออก**: ดับเบิลคลิกที่สี่เหลี่ยมสีเพื่อลบตัวอย่าง**กลยุทธ์การปรับแต่ง:*** **กลับการไล่ระดับสี**: พลิกลำดับสีเพื่อกลับความหมาย (เช่น เขียว=ต่ำ แดง=สูง)
