...
เมื่อคุณเลื่อนเคอร์เซอร์ไปเหนือรูปภาพ ค่าพิกเซลจะแสดงแบบเรียลไทม์:**ตำแหน่งแสดงมูลค่า:*** **ตัวเลขลอยตัวและเส้นสีแดงในคำอธิบายการไล่ระดับสีดัชนี LUT ทางด้านขวา*** **เมื่อขยายเข้าไปอีก ค่าลอยตัวอยู่ใกล้เคอร์เซอร์และพิกเซลที่ไฮไลต์*** แสดงค่าพิกเซล **ใต้เคอร์เซอร์หรือไฮไลต์*** อัปเดตเมื่อคุณเลื่อนเมาส์
...
* แสดงข้อมูล JPG ตามที่แสดงตัวอย่าง
