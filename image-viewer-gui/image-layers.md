...
เมนูแบบเลื่อนลง Image Layers ใน Chloros Image Viewer ช่วยให้คุณสามารถสลับระหว่างเวอร์ชันต่างๆ ของรูปภาพเดียวกันได้อย่างรวดเร็ว ตั้งแต่การบันทึกต้นฉบับไปจนถึงเอาต์พุตการสะท้อนแสงที่ประมวลผลและรูปภาพดัชนีที่คำนวณแล้ว

## เลเยอร์รูปภาพคืออะไร?

ใน Chloros **เลเยอร์** หมายถึงเอาต์พุตรูปภาพต่างๆ ที่ใช้ได้สำหรับรูปภาพต้นฉบับเดียว เมื่อคุณประมวลผลภาพ Chloros จะสร้างหลายเวอร์ชัน:
...
* **รูปภาพดัชนี** (NDVI, NDRE, GNDVI ฯลฯ หากกำหนดค่าดัชนีไว้)**เมนูแบบเลื่อนลงสำหรับตัวเลือกเลเยอร์** ที่มุมขวาบนของโปรแกรมดูรูปภาพ ช่วยให้คุณสลับระหว่างเวอร์ชันเหล่านี้ได้ทันทีโดยไม่ต้องออกจากโปรแกรมดู***
...
{% hint style="info" %}
**เลเยอร์เป้าหมาย**: เลเยอร์นี้จะปรากฏเฉพาะในเมนูแบบเลื่อนลงสำหรับรูปภาพที่มีเป้าหมายการปรับเทียบ ภาพที่ถ่ายแบบปกติจะไม่มีตัวเลือกนี้
{% endhint %}
...
* Multi-band TIFF พร้อมช่องกล้องทั้งหมด
...
* เมื่อนำทางไปยังรูปภาพถัดไป Chloros จะพยายามแสดงเลเยอร์ประเภทเดียวกัน
...
**ใช้ได้เสมอ:*** ✅ JPG (ทุกภาพมีภาพตัวอย่าง JPG)
...
1. เปิด Image 1 สลับไปที่ RAW (NDVI Index)
...
**เป้าหมาย**: ตรวจสอบผลลัพธ์ NDVI ในชุดข้อมูลอย่างรวดเร็ว

1. เปิดภาพที่ประมวลผลภาพแรก
2. เลือก **RAW (NDVI Index)** จากดรอปดาวน์
3. ใช้ปุ่มลูกศร → เพื่อไปยังภาพถัดไป
4. เลเยอร์ NDVI ยังคงอยู่โดยอัตโนมัติ
5. ดำเนินการต่อผ่านรูปภาพทั้งหมด โดยตรวจสอบรูปแบบ NDVI
6. เปลี่ยนเป็น **RAW (NDRE Index)** เพื่อเปรียบเทียบ
...
5. ตรวจสอบค่าพิกเซลว่าอยู่ในช่วงที่คาดหวัง (30-70% สำหรับ NIR, 5-15% สำหรับ Red)
...
* **การใช้งาน**: การวัดและการวิเคราะห์ทางวิทยาศาสตร์**สำหรับ TIFF 16 บิต:**หารด้วย 65,535 เพื่อให้ได้เปอร์เซ็นต์การสะท้อน**สำหรับเปอร์เซ็นต์ 32 บิต:** ค่าต่างๆ แสดงถึงเปอร์เซ็นต์โดยตรง (0.5 = การสะท้อน 50%)
...
* **ตัวอย่าง**:
  * NDVI: -1 ถึง +1 (โดยทั่วไปพืชจะอยู่ที่ 0.4 ถึง 0.9)
...
**ปัญหา**: เลเยอร์ที่คาดไว้ไม่ปรากฏในเมนูแบบเลื่อนลง**สาเหตุที่เป็นไปได้:**
...
**ปัญหา**: รูปภาพเปิดในเลเยอร์ที่ไม่คาดคิด**สาเหตุ**: การตั้งค่าเลเยอร์จากรูปภาพก่อนหน้ายกไปข้างหน้า แต่ไม่มีเลเยอร์นั้นอยู่ในรูปภาพปัจจุบัน**วิธีแก้ปัญหา**: Chloros จะถอยกลับไปเป็น JPG โดยอัตโนมัติเมื่อเลเยอร์ที่ต้องการไม่พร้อมใช้งาน - นี่เป็นพฤติกรรมปกติ

### ไม่เห็นเป้าหมายการสอบเทียบ

**ปัญหา**: เลเยอร์ RAW (เป้าหมาย) ไม่แสดงการตรวจจับเป้าหมาย**สาเหตุที่เป็นไปได้:**
...
* [**การเปิดภาพแบบเต็มหน้าจอ**](opening-an-image-full-screen.md) - คู่มือโปรแกรมดูภาพฉบับสมบูรณ์
